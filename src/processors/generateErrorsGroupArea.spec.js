var mockPackage = require('dgeni-packages/ngdoc/mocks/mockPackage');
...
describe("generateErrorsGroupAreaProcessor", function() {
  ...
  beforeEach(function() {
    ...
    processor = injector.get('generateErrorsGroupAreaProcessor');
    moduleMap = injector.get('moduleMap');
  });

  xit("should create a new doc for each group of components (by docType) in each module", function() {
    var docs = [];
    moduleMap.set('mod1', {
      id: 'mod1',
      name: 'mod1',
  ...
  xit("should not generate componentGroup docs for the 'overview' docType", function() {
